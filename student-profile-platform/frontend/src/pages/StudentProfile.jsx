    ...
    <div className="min-h-screen gradient-bg-subtle">
      ...
      <div ref={profileRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        {certificates.length > 0 && (
          <div className="glass-card p-8 mb-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
            <h2 className="text-2xl font-display font-bold mb-6 dark:text-white">Certificates</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {certificates.map((cert) => (
                <div key={cert.id} className="flex items-center gap-4 p-5 rounded-xl bg-gray-50 dark:bg-surface-700/50 border border-gray-100 dark:border-surface-600 hover:border-amber-300 dark:hover:border-amber-600 transition-colors">
