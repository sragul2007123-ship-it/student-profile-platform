...
export default function Dashboard() {
  ...
  // New item forms
  const [newSkill, setNewSkill] = useState({ skill_name: '', skill_level: 50 })
  const [newProject, setNewProject] = useState({ title: '', description: '', github_link: '', demo_link: '' })
  ...
  const loadData = async () => {
    try {
      ...
      // Load skills, projects, certificates
      const [skillsData, projectsData, certsData] = await Promise.all([
  ...
  const saveProfile = async () => {
    ...
    const cleanUsername = profile.username.replace(/\s+/g, '').toLowerCase()
    ...
    try {
      ...
      showMessage('error', 'Error saving profile: ' + err.message)
      console.error(err)
    }
    setSaving(false)
  }
  ...
  const addSkill = async () => {
    ...
    try {
      ...
      setNewSkill({ skill_name: '', skill_level: 50 })
  ...
  const addProject = async () => {
    ...
    try {
      ...
      setNewProject({ title: '', description: '', github_link: '', demo_link: '' })
              ...
              {activeTab === 'profile' && (
                <div className="animate-fade-in">
                  ...
                  <div className="flex items-center gap-6 mb-8">
                    <div className="w-24 h-24 rounded-full overflow-hidden gradient-bg flex items-center justify-center text-white text-3xl font-bold shadow-xl shadow-primary-500/20">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Profile Photo URL</label>
                      <input
                        type="url"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-400 mt-1">Your profile: /student/{profile.username || 'username'}</p>
                    </div>
                    <div>
                ...
                <div className="animate-fade-in">
                  ...
                  <div className="p-6 rounded-xl bg-gray-50 dark:bg-surface-700/50 border border-gray-100 dark:border-surface-600 mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-end">
                      ...
                      <button onClick={addSkill} className="btn-primary whitespace-nowrap">Add Skill</button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {skills.length === 0 && (
                      <p className="text-center text-gray-400 dark:text-gray-500 py-8">No skills added yet. Add your first skill above!</p>
                    )}
                    {skills.map(skill => (
                      <div key={skill.id} className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-surface-800 border border-gray-100 dark:border-surface-700 group">
                        <div className="flex-1">
                ...
                <div className="animate-fade-in">
                  ...
                  <div className="p-6 rounded-xl bg-gray-50 dark:bg-surface-700/50 border border-gray-100 dark:border-surface-600 mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-end">
                      ...
                      <div className="flex-1">
                        <label className="block text-sm text-gray-500 mb-1">Certificate URL</label>
                        <input
                          type="url"
                          className="input-field"
                          placeholder="https://..."
                      ...
                      <button onClick={addCertificate} className="btn-primary whitespace-nowrap">Add Certificate</button>
                    </div>
                  </div>
